...
public class AuthenticationIT {
    ...
    public void authenticate_WithInvalidCredentials_ReturnErrorMessageStatus400() {
        ...
        responseBody = testClient
                ...
                .uri("/v1/login")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UserLoginDto("maria@email.com", "000000"))
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void authenticate_WithInvalidUsername_ReturnErrorMessageStatus422() {
        ...
        responseBody = testClient
                ...
                .uri("/v1/login")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UserLoginDto("@.com", "123456"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void authenticate_WithInvalidPassword_ReturnErrorMessageStatus422() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/v1/login")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UserLoginDto("maria@email.com", ""))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/v1/login")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UserLoginDto("maria@email.com", "123"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
